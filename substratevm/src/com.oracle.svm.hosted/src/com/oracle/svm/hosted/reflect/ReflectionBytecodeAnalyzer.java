...
public class ReflectionBytecodeAnalyzer extends AbstractInterpreter<ReflectionBytecodeAnalyzer.ReflectionAnalysisValue> {
    ...
    /*
     * Looking up types/fields/methods through a WrappedConstantPool can result
     * in UnsupportedFeatureException(s) being thrown. To avoid these exceptions
     * being thrown, we essentially simulate the behavior of the WrappedConstantPool
     * when looking up the underlying JVMCI type/field/method, but skip the analysis
     * (or hosted) universe lookup.
     */
    ...
    public abstract static class CompileTimeConstant implements ReflectionAnalysisValue {
        ...
        public boolean equals(Object o) {
            ...
            /*
             * The source BCI (BCI of the instruction that placed the value onto
             * the operand stack or in the local variable table) is the source of
             * truth when comparing two compile time constant values (an equal source
             * BCI implies an equal value).
             */
