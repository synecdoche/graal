...
public class ReflectionMetadata {
    ...
    static class ClassMetadata extends AnnotatedElementMetadata {
        ...
        ClassMetadata(HostedType[] classes, RecordComponentMetadata[] recordComponents, HostedType[] permittedSubclasses, Annotation[] annotations, TypeAnnotation[] typeAnnotations) {
    ...
    static class FieldMetadata extends AccessibleObjectMetadata {
        ...
        FieldMetadata(HostedType declaringType, String name, HostedType type) {
            this(false, null, declaringType, name, type, 0, false, null, null, null, LOC_UNINITIALIZED, null);
        }
    }
    ...
    static class MethodMetadata extends ExecutableMetadata {
        ...
        MethodMetadata(boolean complete, JavaConstant heapObject, HostedType declaringClass, String name, HostedType[] parameterTypes, int modifiers, HostedType returnType,
        ...
        MethodMetadata(HostedType declaringClass, String name, HostedType[] parameterTypes, int modifiers, HostedType returnType, HostedType[] exceptionTypes, String signature,
            ...
            this(true, null, declaringClass, name, parameterTypes, modifiers, returnType, exceptionTypes, signature, annotations, parameterAnnotations, annotationDefault, typeAnnotations,
                            reflectParameters,
                            accessor);
        }
        ...
        MethodMetadata(JavaConstant heapObject, Annotation[] annotations, Annotation[][] parameterAnnotations, Object annotationDefault, TypeAnnotation[] typeAnnotations,
            ...
            this(true, heapObject, null, null, null, 0, null, null, null, annotations, parameterAnnotations, annotationDefault, typeAnnotations, reflectParameters, null);
        }

        MethodMetadata(HostedType declaringClass, String name, HostedType[] parameterTypes) {
            this(false, null, declaringClass, name, parameterTypes, 0, null, null, null, null, null, null, null, null, null);
        }
    }
