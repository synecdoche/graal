...
// Checkstyle: disallow direct annotation access
    ...
    private Class<?>[] getDeclaredClasses0() {
        return ImageSingletons.lookup(MethodMetadataDecoder.class).parseClasses(classesEncoding);
    }
    ...
    private Class<?>[] getPermittedSubclasses0() {
        ...
        return ImageSingletons.lookup(MethodMetadataDecoder.class).parseClasses(permittedSubclassesEncoding);
    }
